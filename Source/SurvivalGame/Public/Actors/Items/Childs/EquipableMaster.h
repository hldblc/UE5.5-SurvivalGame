...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Equipable|Socket")
	 ...
	 * This property is editable in the editor and accessible in Blueprint scripts.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Equipable|AnimationState")
	E_EquipableAnimationStates AnimationState;


	/**
	 * Implements the logic to retrieve the equipable item's information,
	 * including the socket name and animation state.
	 *
	 ...
	 */
	virtual void GetEquipableInfo_Implementation(FName& OutSocketName, E_EquipableAnimationStates& OutEquipableAnimationState) override;
